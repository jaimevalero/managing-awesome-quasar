var lists = new Map();
lists.set("30-seconds-of-css", [
  "30-seconds/30-seconds-of-css",
  "30-seconds/30-seconds-web",
]);

lists.set("awesome-datascience", [
  "01org/idlf",
  "adamerose/pandasgui",
  ...
  "jakevdp/PythonDataScienceHandbook|Python",
  "jinglescode/python-signal-processing",
  "jnv/lists",
  "josephmisiti/awesome-machine-learning",
  "JosPolfliet/awesome-datascience-ideas",
  "jtleek/datasharing",
  "JuliaLang/IJulia.jl",
  ...
  "leomaurodesenv/game-datasets#readme",
  ...
  "nerox8664/awesome-computer-vision-models",
  "NervanaSystems/neon",
  "polyaxon/polyaxon",
  "ppwwyyxx/tensorpack",
  "pystruct/pystruct",
...
lists.set("awesome-cli-apps", [
  ...
  "alebcay/awesome-shell#readme",
  "alejandrogallo/papis",
  ...
  "herrbischoff/awesome-command-line-apps#readme",
  "herrbischoff/awesome-macos-command-line#readme",
  ...
  "jkbrzt/httpie",
  "joelgeorgev/google-wifi-status",
  "joeyespo/grip",
  "jonas/tig",
  "JPeer264/node-semantic-git-commit-cli",
  "julianhyde/sqlline",
  "junegunn/fzf",
  "k4m4/terminals-are-sexy#readme",
  ...
  "sindresorhus/awesome",
  "sindresorhus/awesome-nodejs#command-line-apps",
  "sindresorhus/bundle-id-cli",
  ...
  "sindresorhus/open-shortcut-cli",
  "sindresorhus/osx-version-cli",
  ...
  "spolu/warp",
  "stedolan/jq",
  "stevemao/awesome-git-addons#readme",
  ...
  "Treri/cmatrix",
  "ttscoff/doing",
  "unixorn/awesome-zsh-plugins#readme",
  "vim/vim",
  ...
  "xxczaki/oji",
  "yaronn/wopr",
  "yask123/AutoScreenshotUploader",
...
lists.set("awesome-java", [
  ...
  "chrisengelsma/almanac-converter",
...
lists.set("jquery-tips-everyone-should-know", [
...
lists.set("awesome-go", [
  ...
  "aws/aws-sdk-go",
  "awsong/MMSEGO",
  "axelspringer/generator-go-lang",
  "axelspringer/go-chronos",
  "axiomhq/hyperloglog",
  "aybabtme/portproxy",
  "aymerick/douceur",
  "aymerick/raymond",
  ...
  "blind-oracle/riemann-relay",
  "blockloop/scan",
  "bluele/gcache",
  "BlueOwlOpenSource/nject",
  "bndr/gopencils",
  "bndr/gotabulate",
  "bnkamalesh/currency",
  "bnkamalesh/errors",
  ...
  "dgryski/go-jump",
  "dh1tw/gosamplerate",
  "diankong/GoDocTooltip",
  "didi/gendry",
  "didip/tollbooth",
  "diegomarangoni/typenv",
  "dietsche/textbelt",
  "digitalcrab/browscap_go",
  "digota/digota",
  ...
  "go-ego/gse",
  "go-ego/riot",
  "go-email-validator/go-email-validator",
  "go-ffmt/ffmt",
  "gofiber/fiber",
  "gofrs/uuid",
  ...
  "kinbiko/jsonassert",
  "kirillDanshin/avgRating",
  "kirillDanshin/dlog",
  "kirillDanshin/llb",
  "kirillDanshin/nulltime",
  "kisielk/errcheck",
  "kkyr/fig",
  "knadh/koanf",
  "kniren/gota",
  ...
  "michiwend/goplaceholder",
  "mickep76/encdec",
  "mickep76/mapslice-json",
  ...
  "prashantgupta24/firewalld-rest",
  "prashantgupta24/go-clip",
  ...
  "rbrahul/gofp",
  "rbretecher/go-postman-collection",
  ...
  "sindresorhus/awesome",
  "sinhashubham95/bleep",
  "sinhashubham95/jsonic",
  ...
  "thedevsaddam/retry",
  "thedevsir/gosuccinctly",
  "theia-ide/go-language-server",
...
lists.set("Awesome-pytorch-list", [
  ...
  "onlytailei/A3C-PyTorch:PyTorch",
...
lists.set("awesome-scalability");

lists.set("awesome-hacking", [
  "0xd4d/antinet",
  "0xd4d/de4dot",
  "0xd4d/dnSpy",
  "Akdeniz/mitmsocks4j",
  ...
  "bkimminich/juice-shop#docker-container--",
  ...
  "OWASP/Amass",
  "owasp/nodegoat#option-3---run-nodegoat-on-docker",
  "pfalcon/ScratchABit",
  "portantier/habu",
...
lists.set("awesome-deep-learning", [
  "alankbi/detecto",
  "albu/albumentations",
  "AMAI-GmbH/AI-Expert-Roadmap",
  "amitness/toolbox",
  ...
  "baidu/paddle",
  "benedekrozemberczki/awesome-graph-embedding",
  "benedekrozemberczki/karateclub",
  "caffe2/caffe2",
  "catalyst-team/catalyst",
...
lists.set("awesome-wpo", [
  "addyosmani/critical",
  "addyosmani/grunt-uncss",
  "addyosmani/psi",
  "addyosmani/timing.js",
  "addyosmani/tmi",
  "aFarkas/lazysizes",
  "aheckmann/gm",
  "ajay2507/lasso-analyzer",
  "andyshora/grunt-yslow",
  "ApoorvSaxena/lozad.js",
  "asciidisco/perfjankie-test.",
  "aslansky/gulp-sprite",
  ...
  "stoyan/cssshrink",
  "stoyan/prettyugly",
  "stoyan/yuicompressor",
  "svg/svgo",
  "Swaagie/minimize",
  "tedious/JShrink",
  "tjko/jpegoptim",
  "tkadlec/grunt-perfbudget",
  "torrottum/gulp-cssshrink",
  "vvo/lazyload",
  ...
  "yui/yuicompressor",
  "zeman/perfmap",
  "zenorocha/browser-calories-chrome",
]);

lists.set("awesome-aws", [
  "99designs/aws-vault",
  "achiku/jungle",
  "AdRoll/hologram",
  "Alephbet/gimel",
  ...
  "awslabs/awscli-cookbook",
  "awslabs/aws-codedeploy-plugin",
  "awslabs/aws-codedeploy-samples",
  "awslabs/aws-codepipeline-custom-job-worker",
  "awslabs/aws-codepipeline-jenkins-aws-codedeploy_linux",
  "awslabs/AWSCodePipeline-Jenkins-AWSCodeDeploy_Windows",
  "awslabs/aws-codepipeline-plugin-for-jenkins",
  "awslabs/aws-codepipeline-s3-aws-codedeploy_linux",
  "awslabs/AWSCodePipeline-S3-AWSCodeDeploy_Windows",
  "awslabs/aws-data-wrangler",
  "awslabs/aws-demo-php-simple-app",
  ...
  "awslabs/aws-device-farm-sample-app-for-android",
  "awslabs/aws-dynamodb-encryption-java",
  "awslabs/aws-dynamodb-examples",
  ...
  "awslabs/aws-hal-client-java",
  "awslabs/aws-java-sample",
  "awslabs/aws-lambda-redshift-loader",
  "awslabs/aws-mobile-sample-wif",
  "awslabs/aws-mobile-self-paced-labs-samples",
  "awslabs/aws-model-validators",
  ...
  "awslabs/aws-sdk-js-sample-video-transcoder",
  "awslabs/aws-sdk-net-samples",
  "awslabs/aws-sdk-unity-samples",
  "awslabs/aws-sdk-xamarin",
  "awslabs/aws-sha256-agentcs",
  "awslabs/aws-shell",
  "awslabs/aws-spot-labs",
  "awslabs/aws-training-demo",
  "awslabs/aws-tvm-anonymous",
  "awslabs/aws-tvm-identity",
  "awslabs/cfncluster",
  "awslabs/cfncluster-cookbook",
  "awslabs/cfn-python-lint",
  "awslabs/chalice",
  "awslabs/cloudsearchable",
  "awslabs/cloudwatch-logs-subscription-consumer",
  "awslabs/cognito-sample-nodejs",
  "awslabs/create-thumbnails-lambda",
  "awslabs/data-pipeline-samples",
  "awslabs/dynamodb-cross-region-library",
  "awslabs/dynamodb-geo",
  "awslabs/dynamodb-import-export-tool",
  "awslabs/dynamodb-online-index-violation-detector",
  "awslabs/dynamodb-streams-kinesis-adapter",
  "awslabs/dynamodb-tictactoe-example-app",
  "awslabs/dynamodb-titan-storage-backend",
  ...
  "awslabs/eb-python-flask",
  "awslabs/eb-wif-sample",
  "awslabs/ecs-blue-green-deployment",
  "awslabs/ecs-cloudwatch-logs",
  "awslabs/ecs-demo-php-simple-app",
  "awslabs/ecs-mesos-scheduler-driver",
  "awslabs/ecs-refarch-continuous-deployment",
  "awslabs/ecs-task-kite",
  "awslabs/elasticache-cluster-config-net",
  "awslabs/emr-bootstrap-actions",
  "awslabs/emr-sample-apps",
  "awslabs/java-meme-generator-sample",
  "awslabs/kinesis-log4j-appender",
  "awslabs/kinesis-poster-worker",
  "awslabs/kinesis-storm-spout",
  "awslabs/lambda-ecs-worker-pattern",
  "awslabs/lambda-refarch-fileprocessing",
  "awslabs/lambda-refarch-iotbackend",
  "awslabs/lambda-refarch-mobilebackend",
  "awslabs/lambda-refarch-webapp",
  "awslabs/logstash-input-dynamodb",
  "awslabs/logstash-output-amazon_es",
  "awslabs/logstash-output-cloudwatchlogs",
  "awslabs/machine-learning-samples",
  "awslabs/mqtt-kinesis-bridge",
  "awslabs/opsworks-attribute-customization",
  "awslabs/opsworks-capistrano",
  "awslabs/opsworks-cloudwatch-logs-cookbooks",
  "awslabs/opsworks-demo-php-photo-share-app",
  "awslabs/opsworks-demo-php-simple-app",
  "awslabs/opsworks-demo-rails-photo-share-app",
  "awslabs/opsworks-elasticsearch-cookbook",
  "awslabs/opsworks-example-cookbooks",
  "awslabs/opsworks-first-cookbook",
  "awslabs/opsworks-windows-demo-cookbooks",
  "awslabs/opsworks-windows-demo-nodejs",
  "awslabs/py-flask-signup-docker",
  "awslabs/railsconf2013-tech-demo",
  "awslabs/reinvent2013-js-blog-demo",
  "awslabs/reinvent2013-mobile-photo-share",
  "awslabs/reinvent2014-scalable-site-management",
  "awslabs/reinvent2015-dev309",
  "awslabs/route53-infima",
  "awslabs/s2n",
  "awslabs/service-discovery-ecs-consul",
  "awslabs/simplebeerservice",
  "awslabs/timely-security-analytics",
  "awslabs/todo-sample-app",
  "awslabs/todo-sample-app-cookbooks",
  ...
  "mcohen01/amazonica",
  "mcohen01/amazonica#documentation",
  "mcohen01/amazonica#installation",
  "meducation/propono",
  "mentum/lambdaws",
  ...
  "phstc/shoryuken",
  "pplu/aws-sdk-perl",
  "pplu/aws-sdk-perl#installation",
  ...
  "winebarrel/roadworker",
  "Yelp/mrjob",
]);

lists.set("openshift-is-awesome", [
  "dudash/candv",
  "dudash/jenkins-slave-nodejs6",
  "dudash/mssql-docker",
  "dudash/openshift-docker-solr",
  "dudash/openshiftexamples-autoscaling",
  "dudash/openshiftexamples-cicdpipeline",
  "dudash/openshiftexamples-customhawkularmetrics",
  "dudash/openshiftexamples-hellokitura",
  "dudash/openshiftexamples-javawebapp",
  "dudash/openshiftexamples-nodemongo",
  "dudash/openshiftexamples-s2iwrappercustomeap",
  "dudash/openshiftexamples-simpleswift",
  "dudash/openshiftexamples-solrdemo",
  "dudash/openshiftexamples-springbootrestservice",
  "dudash/openshiftexamples-tomcatmysql",
  "dudash/openshiftexamples-vertxcircuitbreaker",
  "dudash/openshift-vscode-extension",
  "dudash/openshift-workshops",
  "dudash/openshift-znc",
  "dudash/s2i-solr",
  "dudash/s2i-swift",
  "sindresorhus/awesome",
]);

lists.set("frontend-dev-bookmarks", ["sindresorhus/awesome"]);

lists.set("awesome-react", [
  ...
  "dacz/apollo-bridge-link",
  "dataformsjs/dataformsjs",
  "davidchang/ngReact",
  "davidkpiano/xstate",
  "davidtheclark/react-aria-modal",
  "ddispaltro/sbt-reactjs",
  ...
  "douglasjunior/react-recaptcha-that-works",
  "Drawbotics/react-apollo-redux",
  "duncanbeevers/gulp-jade-react",
  ...
  "EarlGeorge/timetable",
  "eiriklv/react-masonry-mixin",
  "eiriklv/react-packery-mixin",
  "elastic/eui",
  "elastic/kibana",
  ...
  "JamesWatling/react-native-list-view-select",
  ...
  "matthieu-beteille/redux-data-fx",
  ...
  "mpeyper/react-hooks-testing-library",
  "mquan/cortex",
  "mui-org/material-ui",
  "muut/riotjs",
  "mzabriskie/react-draggable",
  "nashvail/SplashWalls",
  "nfl/react-helmet",
  "ngokevin/aframe",
  "Nozbe/WatermelonDB",
  "nteract/semiotic",
  ...
  "sarneeh/reaptcha",
  "securingsincity/backbone-react-ui",
  "segmentio/evergreen",
  ...
  "sonnylazuardi/ziliun-react-native",
  ...
  "suyesh/redux-state-validator",
  "swannodette/om",
  "swipely/state-trooper",
  ...
  "tiaanduplessis/awesome-react-talks",
  "tleunen/react-clickdrag-mixin",
  ...
  "uber/react-map-gl",
  "uber/react-vis",
  "universal-model/universal-model-react",
  "usepropeller/react.backbone",
  "vadimdemedes/ink",
  "vaffel/sql-to-graphql",
  "vazco/uniforms",
  "vercel/next.js",
  "vesparny/statty",
  "vjeux/react-xtags",
  "vojtajina/react-with-di",
  "Volicon/NestedReact",
  "Volicon/valuelink",
  "wearefractal/react-responsive",
  "webonyx/graphql-php",
...
lists.set("awesome-cpp", [
  ...
  "boostcon/cppnow_presentations_2015",
  "boostcon/cppnow_presentations_2016",
...
lists.set("awesome-ddd", [
  ...
  "pilloPl/event-source-cqrs-sample",
  ...
  "volak/eShopOnContainersDDD",
  "volak/TodoMVC-DDD-CQRS-EventSourcing",
...
lists.set("awesome-flask", [
  ...
  "pythoncn/june",
  "qiajigou/flask-zipkin",
  "rdegges/flask-heroku-cacheify",
  "realpython/discover-flask",
  "rhyselsmore/flask-reggie",
  ...
  "vinceprignano/chatapp",
  "wrobstory/mcflyin",
  "zalando/connexion",
  "zzzsochi/Flask-Gravatar",
]);

lists.set("awesome-blockchain", [
  "protontypes/libreselery",
  "yfgeek/BlockVotes",
]);

lists.set("awesome-mac", [
  "2ndalpha/gasmask",
  "720kb/ndm",
  "abynim/UserFlows",
  "adobe/brackets",
  ...
  "atom/atom",
  "audacity/audacity",
  "balsikandar/Android-Studio-Plugins#readme",
  "Bash-it/bash-it",
  "bdash-app/bdash",
  ...
  "BubuAnabelas/awesome-markdown#tools",
  ...
  "dinedal/textql",
  "dnote/dnote",
  "dreikanter/sublime-bookmarks#readme",
  "driftyco/ionic",
  "dsward2/macSVG",
  "dteoh/SlowQuitApps",
  "dustinrue/ControlPlane",
  "duyquoc/ScreenToLayers-",
  "dwarvesf/hidden",
  "egoist/eme",
  "electron/electron",
  "emacs-tw/awesome-emacs#readme",
  "Eugeny/terminus",
  ...
  "fastogt/fastoredis",
  "fikovnik/ShiftIt",
  "fisherman/awesome-fish-shell#readme",
  "gabrielbull/react-desktop",
  ...
  "laurent22/joplin",
  "learn-anything/alfred-workflows#readme",
  "learn-anything/safari-extensions#readme",
  "leits/MeetingBar",
  "lessmess-dev/touch-emoji",
  "lhc70000/iina",
  ...
  "sindresorhus/quick-look-plugins#readme",
  ...
  "vim/vim",
  "vishaltelangre/bindPDF",
  "vishaltelangre/Kyapchar",
...
lists.set("awesome-apache-airflow", [
  "airflow-plugins/",
  "ajbosco/dag-factory",
  ...
  "bitnami/bitnami-docker-airflow-scheduler",
  "bitnami/bitnami-docker-airflow-worker",
  "chriscardillo/gusty",
  "criccomini/2862667822af7fae8b55682faef029a7",
  "danielvdende/data-testing-with-airflow",
  "datagovsg/airflow-pipeline",
  "digitalearthafrica/deafrica-airflow",
  "EamonKeane/airflow-GKE-k8sExecutor-helm",
  "godatadriven/whirl",
  "GoogleCloudPlatform/airflow-operator",
  "GoogleCloudPlatform/oozie-to-airflow",
  "helm/charts",
  "industrydive/fileflow",
  "Javier162380/AirflowKuberentesDebugger",
  ...
  "politools/airflow-pianka-sh",
  "politools/dag-checks",
  ...
  "tekn0ir/airflow-chart",
  "villasv/aws-airflow-stack",
]);

lists.set("awesome-machine-learning", [
  "abhik/pebl",
  "aboSamoor/polyglot",
  "activeloopai/Hub",
...
lists.set("awesome-devops", [
  ...
  "xiphux/gitphp",
  "yuki-kimoto/gitprep,",
  "yysun/Git-Web-Access",
  "zaproxy/zaproxy",
  "Zentyal/zentyal,",
  "zstackorg/zstack",
]);

lists.set("terminals-are-sexy", [
  "ajeetdsouza/zoxide",
  "anthraxx/ant-zsh",
  "antonmedv/fx",
  "arialdomartini/oh-my-git",
...
lists.set("awesome-selfhosted", [
  "0xERR0R/blocky",
  "1backend/1backend",
  "2600hz/KAZOO",
  "39aldo39/DecSyncCC",
  "aaronpk/Meetable",
  "abdullahselek/ReducePy",
  "abienvenu/Kyela",
  "abilian/abilian-sbe",
  "abrenaut/posio",
  ...
  "anderspitman/fibridge-proxy-rs",
  ...
  "helpyio/helpy",
  "herrbischoff/screaming-liquid-tiger",
  "hexojs/hexo",
  "Hextris/hextris",
  "hitobito/hitobito",
  "hkalexling/Mango",
  ...
  "mirego/accent",
  "mirumee/saleor",
  "Mission-Kontrol/MissionKontrol-rails",
  "misterunknown/ifm",
  ...
  "n1trux/awesome-sysadmin#code-review_",
  "n1trux/awesome-sysadmin#continuous-integration--continuous-deployment_",
  "n1trux/awesome-sysadmin#distributed-filesystems_",
  "n1trux/awesome-sysadmin#dns_",
  "n1trux/awesome-sysadmin#identity-management_",
  "n1trux/awesome-sysadmin#it-asset-management_",
  "n1trux/awesome-sysadmin#monitoring",
  "n1trux/awesome-sysadmin#vpn_",
  "n1trux/awesome-sysadmin#web_",
  "n1try/anchr",
  "n1try/http2-serverpush-proxy",
  "n1try/mininote",
  "n1try/wakapi",
  "n8n-io/n8n",
  "ncarlier/feedpushr",
  "ncarlier/nunux-keeper",
  "ncarlier/readflow",
  "nebulade/meemo",
  "nebulade/surfer",
  ...
  "onurakpolat/awesome-analytics_",
  ...
  "tommyku/link-shortener-front-end",
  "tonioo/modoboa",
  "tontof/kriss_feed",
  "tootsuite/mastodon",
  "TracksApp/tracks",
...
lists.set("awesome-sysadmin", [
  "afaqurk/linux-dash",
  "allegro/ralph",
  "allinurl/goaccess",
  "AnalogJ/capsulecd",
  "AppScale/appscale",
  "averna-syd/LibreMailer",
  "bborn/lewsnetter",
  "block8/phpci",
  "borgbackup/borg",
  "bosun-monitor/bosun,",
  ...
  "jordansissel/fpm",
  "kairosdb/kairosdb",
  "Kickball/awesome-selfhosted#analytics",
  "kickball/awesome-selfhosted#email",
  "Kickball/awesome-selfhosted#file-transfersynchronization",
  "Kickball/awesome-selfhosted#groupware",
  "Kickball/awesome-selfhosted#project-management",
  "Kickball/awesome-selfhosted#ticketing",
  "Kickball/awesome-selfhosted#wikis,",
  "Kickball/awesome-selfhosted#xmpp",
  "kubernetes/kubernetes,",
  "minio/minio",
  "mojeda/ServerStatus",
  "moul/awesome-ssh",
  "n1trux/awesome-donations",
  "Netflix/vector",
  "netxms/netxms",
  "odoucet/pdns-gui",
  "ohwgiles/laminar",
...
lists.set("awesome-courses", [
  ...
  "sindresorhus/awesome",
  "torch/torch7",
  "ut-cs378-vision-2014fall/course-info",
  "VoLuong/Materials-CS193A-Android-App-Development-Standford",
  "yandexdataschool/Practical_RL",
  "yandexdataschool/Practical_RL#syllabus",
]);

lists.set("awesome-kubernetes");

lists.set("free-for-dev", [
  "evolus/pencil",
  "features/actions(Free",
  "features/packages",
  "ligurio/awesome-ci",
  "marketplace/accesslint",
  "marketplace/graphql-inspector",
  "marketplace/imgbot",
  "marketplace/typo-ci",
...
lists.set("awesome-malware-analysis", [
  "0xd4d/de4dot",
  "0xd4d/dnSpy",
  "504ensicsLabs/DAMM",
  "9b/malpdfobj",
  ...
  "F-Secure/see",
  "gleblanc1783/3c8e6b379fa9d646d401b96ab5c7877f",
  "google/binnavi",
  "guelfoweb/peframe",
  "gurnec/HashCheck",
  "hellman/xortool",
...
lists.set("awesome-security", [
  "0x4D31/awesome-threat-detection",
  "504ensicsLabs/LiME.git",
  "51j0/Android-Storage-Extractor",
  "99designs/aws-vault",
  "aboul3la/Sublist3r",
  "amocrenco/owasp-testing-checklist-v4-markdown",
  "aol/moloch",
  ...
  "meirwah/awesome-incident-response",
  "mozilla/sops",
  "mpesen/awesome-industrial-control-system-security",
  "nbs-system/naxsi",
  "Neo23x0/Loki",
  "nil0x42/phpsploit",
  "OpenSOC/opensoc",
  ...
  "remiflavien1/awesome-anti-forensic",
  "rfunix/Pompem",
...
lists.set("awesome-ruby", [
  ...
  "globalize/globalize",
  "gmontard/helioth",
  "gnoso/spreadsheet_report",
  "grosser/parallel",
  "guilhermesad/rspotify",
  "haml/haml",
  "hanklords/flickraw",
  "harvesthq/simple_xlsx_writer",
  "hassox/warden",
  "hexgnu/linkedin",
  "httprb/http",
  "indirect/haml-rails",
  ...
  "nixme/jazz_hands",
  "NoamB/sorcery",
  "noeticpenguin/RubySpamAssassin",
  "nomad/houston",
  "norman/friendly_id",
  "nov/fb_graph",
  "octokit/octokit.rb",
  ...
  "zaru/webpush",
  "zdavatz/spreadsheet",
  "zenchild/viewpoint-spws",
  "zhangsu/seal",
  "ziadoz/awesome-php",
  "zurb/foundation-rails",
]);

lists.set("awesome-actions", [
  ...
  "bharathvaj1995/clockwork-sms-action",
  "Bhupesh-V/memer-action",
  "bobheadxi/gobenchdata",
  "Borales/actions-yarn",
  "BoyWithSilverWings/generate-og-image",
  "br3ndonland/f9c753eb27381f97336aa21b8d932be6",
  ...
  "Decathlon/slate-builder-action",
  ...
  "haythem/public-ip",
  "heowc/action-hexo",
  "hiwelo/new-dependencies-action",
  ...
  "Jerome1337/golint-action",
  "jessicalostinspace/commit-difference-action",
  "jessicalostinspace/cut-release-action",
  "jessicalostinspace/github-action-get-regex-branch",
  "joelwmale/codeception-action",
  "jonelantha/gatsby-s3-action",
  "jonico/jenkinsfile-runner-github-actions",
  ...
  "Krucible/krucible-github-action",
  "lannonbr/issue-label-manager-action",
  "lannonbr/vsce-action",
  "logankilpatrick/StackOverflowBot",
  "lukka/run-cmake",
  "lukka/run-vcpkg",
  "machine-learning-apps/actions-argo",
  "machine-learning-apps/actions-chatops",
  "machine-learning-apps/gke-argo",
  "machine-learning-apps/gke-kubeconfig",
  "machine-learning-apps/gpr-docker-publish",
  ...
  "marketplace/actions",
  "MarvinJWendt/run-node-formatter",
  "max/awesome-lint",
  "maxim-lobanov/setup-cocoapods",
  "maxim-lobanov/setup-xamarin",
  ...
  "MeilCli/nuget-update-check-action",
  ...
  "NikeNano/kubeflow-github-action",
  ...
  "phishy/wflow",
  "phonito/phonito-scanner-action",
  "protontypes/libreselery",
  ...
  "UnicornGlobal/has-changes-action",
  ...
  "Workshop64/buildpulse-action",
  "WyriHaximus/github-action-close-milestone",
  "WyriHaximus/github-action-create-milestone",
  ...
  "yavisht/deploy-via-surge.sh-github-action-template",
...
lists.set("awesome-mysql", [
  ...
  "maxbube/mydumper",
  "morgo/mysql-compatibility-config",
  "mysql/mysql-server",
  "mysql/mysql-sys",
  "ocelot-inc/ocelotgui",
  "okbob/pspg",
  "OmniDB/OmniDB",
  "percona/percona-pacemaker-agents",
  "pingcap/dm",
  "pingcap/dumpling",
  "pingcap/go-tpc",
  "pingcap/tidb",
  ...
  "PyMySQL/PyMySQL",
  "renecannao/proxysql",
  "samlambert/hubot-mysql-chatops",
  "sequelpro/sequelpro",
...
lists.set("awesome-javascript", [
  ...
  "CodyHouse/full-page-intro-and-navigation",
  ...
  "CreateJS/SoundJS",
  "creationix/step",
  "creative-punch/jQuery.adaptive-slider",
  "CrossEye/ramda",
  "crozynski/Fluid-Squares",
  "cubiq/iscroll",
  "cujojs/curl",
  "cujojs/most",
  "cujojs/when",
  ...
  "josscrowcroft/accounting.js",
  "josscrowcroft/money.js",
...
lists.set("awesome-bootstrap", [
  "akveo/blur-admin",
  "akveo/ngx-admin",
  "angular-ui/bootstrap",
  "Ehesp/Responsive-Dashboard",
...
lists.set("awesome-raspberry-pi", [
  "AdguardTeam/AdGuardHome",
  "anshulahuja98/pi_payments",
  ...
  "cjimti/iotwifi",
  "cyoung/stratux",
  "Defcon27/RasComm-RaspberryPi-MorseCode-Translator",
  "Drewsif/PiShrink",
  "eliddell1/Project-Blue-Fist",
  "epeios-q37/atlas-python",
  "euniceylee/waves",
  "evancohen/smart-mirror",
  "evancohen/sonus",
  "evilsocket/pwnagotchi",
  "farjump/raspberry-pi",
  ...
  "r0hi7/tortipi",
  "rajeshkumarkhadka/Pi-Image-Capturer",
  "resin-io-playground/resin-bridge",
  "rootzoll/raspiblitz",
  "rothgar/rpi-wordpress",
  "rothman857/chronometer",
  "RPi-Distro/pi-gen",
  "rsta2/circle",
  "samaaron/sonic-pi",
  "samyk/poisontap",
...
lists.set("github-cheat-sheet", [
  ...
  "github/linguist",
  "gorosgobe/git-god",
  "octicons/octicons@1200x630.png",
  "octokit/octokit.rb",
  ...
  "sindresorhus/awesome",
  "tiimgreen/10545817",
  "tiimgreen/10545817.pibb",
  "tiimgreen/github-cheat-sheet",
  "tiimgreen/github-cheat-sheet#aliases.*",
  "tiimgreen.keys](https:/",
  "tiimgreen.png](https:/",
  "unixorn/git-extra-commands",
  "{user}/{repo}",
]);

lists.set("awesome-zsh-plugins", [
  "0532/wang-iterm-zsh",
  "0b10/cheatsheet",
  "0b10/rc-files",
  "0i0/0i0.zsh-theme",
  ...
  "akz92/clean",
  "alarangeiras/alarangeiras-zsh-theme",
  "alejandromume/macos-zsh-theme",
  "alepimentel/ale-zsh",
  "Alexandresl/rocket-zsh-theme",
  "alexbarton/ax-zsh",
  "alexchmykhalo/superconsole",
  "alexdesousa/hab",
  "alexdesousa/oath",
  "alexeimun/cobalt2git",
  "AlexGascon/pipenv-oh-my-zsh",
  "AlexisBRENON/oh-my-zsh-reminder",
  "algosuna/neon-potato",
  "al-jshen/zshplug-rs-example",
  "Aloxaf/fzf-tab",
  "amirali313/zsh313-theme",
  "amstrad/oh-my-matrix",
  "anatolykopyl/doas-zsh-plugin",
  "AndiH/oh-my-zsh-ys-cluster-theme",
  "andrejreznik/rho-zsh-theme",
  "andrepolischuk/min",
  "andrewbonnington/vox.plugin.zsh",
  "andrewferrier/fzf-z",
  "AndrewHaluza/zsh-update-plugin",
  "AndrewHaluza/zsh-web-open",
  "andymcguinness/andys-theme",
  ...
  "beaugalbraith/jtool-completion",
  "belak/prezto-contrib](https:",
  "belak/zsh-utils",
  ...
  "bhayward93/Linus-rants-ZSH",
  "bhilburn/hackersaurus",
  "bhilburn/powerlevel9k",
  "bigdave/hematite",
  "bjrowlett2/apple-zsh-theme",
  ...
  "cmaahs/search-directory-history",
  ...
  "coot/zsh-haskell",
  "CorradoRossi/oh-my-zsh-atom-plugin",
  "corvofeng/joe-completion",
  "cowboyd/zsh-emacs",
  "cowboyd/zsh-rust",
  "cowboyd/zsh-volta",
  "crazybooot/laravel-zsh-plugin",
  "CristianCantoro/colorbira-zsh-theme",
  "cristiancavalli/ys-zsh-custom-theme",
  "cryocaustik/cryo-zsh-theme",
  "csurfer/tmuxrepl",
  "cubasepp/zsh-bogo-theme",
  "C-uo/zsh-nodenv",
  "Curly-Mo/last-working-dir-tmux",
  "cusxio/delta-prompt",
  "Czocher/gpg-crypt",
  "d12frosted/cabal.plugin.zsh",
  "d12frosted/kitsunebook.plugin.zsh",
  "Dabz/kafka-zsh-completions",
  "dalang/oh-my-zsh_razor_plugin",
  "dalefukami/accurev-zsh",
  "dambrogia/oh-my-zsh-plugin-magento-2",
  "damofthemoon/zsh-quotify",
  "danihodovic/steeef",
  "dannynimmo/punctual-zsh-theme",
  "darrenbutcher/plugin",
  "DarrinTisdale/zsh-aliases-exa",
  "darvid/zsh-poetry",
  "davidafsilva/vert.x-omz-plugin",
  "davidde/git",
  ...
  "david-treblig/locate-sublime-projects-cli",
  "davydovanton/excess.zsh-theme",
  "davydovanton/hanami-zsh",
  ...
  "derry96/hitokoto",
  "dersam/staples",
  "designfrontier/lonestar-zsh-theme",
  "desyncr/auto-ls",
  ...
  "escalate/oh-my-zsh-proxy-plugin",
  ...
  "fabiokiatkowski/exercism.plugin.zsh",
  "fALKENdk/mylocation",
  ...
  "freak2geek/zshrc",
  "FreebirdRides/oh-my-zsh-aws-mfa",
  "freshshell/fresh",
  "fritzccc/fritz-zsh-theme",
  "frodoslaw/milight-zsh",
  "frontendmonster/oh-my-zsh-skill-theme",
  ...
  "fuzzylogiq/autopkg-zsh-completion",
  "gabrielecanepa/zsh-custom",
  "gabrielelana/awesome-terminal-fonts",
  "gagbo/moux",
  "gangleri/pipenv",
  "gantoreno/saturn-prompt",
  "gantsign/zsh-plugins",
  "gcaracuel/gaia.zsh-theme",
  "gcarrarom/oh-my-guish",
  "gdsrosa/minimal_improved",
  "gentoo/gentoo-zsh-completions",
  "geometry-zsh/geometry",
  "gepoch/oh-my-zsh-dirstack",
  "gerges/oh-my-zsh-jira-plus",
  "gersontpc/zsh-theme-grs",
  "GetAmbush/deepx-zsh-plugin",
  "getantibody/antibody",
  ...
  "ice-bear-forever/bubblegum-zsh",
  ...
  "inimicus/z4rr3t",
  "Insert-Creative-Name-Here/mzpm",
  "inspectahstack/zsh2000",
  "inutano/eggshausted",
  "IOsonoTAN/magico",
  "iplaces/astro-zsh-theme",
  "isqua/bureau",
  "isuke/droolscar",
  "Itsnexn/R3vers-zsh-theme",
  ...
  "jayree/sfdx-autocomplete-plugin",
  "jclementex/jc-zsh-theme",
  "jcxavier/oh-my-zsh-duell",
  ...
  "jhipster/jhipster-oh-my-zsh-plugin",
  ...
  "joepjoosten/aws-cli-mfa-oh-my-zsh",
  "joepvd/grep2awk",
  "joepvd/zsh-hints",
  "johnhamelink/rvm-zsh",
  "johnramsden/zsh-zsnapac",
  "jondot/awesome-devenv",
  "jonmosco/kube-ps1",
  "Jon-Schneider/jon.zsh-theme",
  "joow/macos",
  "joow/youtube-dl",
  ...
  "julienvanderkluft/ykmam-zsh-theme",
  "junegunn/fzf,",
  ...
  "lashoun/slugify",
  "laurenkt/zsh-vimto",
  "lcrespom/oh-my-zsh-history-popup",
  "le0me55i/zsh-extract",
  "le0me55i/zsh-systemd",
  "leandromatos/pre-theme",
  "leejongyoung/asdf.plugin.zsh",
  "leguim-repo/mike-was-here-theme",
  "leighmcculloch/zsh-theme-enormous",
  "lejeunerenard/dbic-migration-env",
  "Lenart12/ice.zsh-theme",
  "lenguyenthanh/nt9-oh-my-zsh-theme",
  "leonjza/history-here",
  ...
  "lighthaus-theme/zsh",
  "lildude/fzf-prezto",
  "linux-china/oh-my-zsh-spring-boot-plugin",
  ...
  "luismayta/zsh-notify",
  "lukaszolszewski/mage2docker",
  ...
  "MartinWie/ohmyzsh-theme-mad",
  "martnu/glimmer",
  "marzocchi/zsh-notify",
  "masaakifuruki/emoji.zsh-theme",
  "mashaal/wild-cherry",
  "mashdots/schminitz-v2",
  "mastern2k3/taskbook-zsh-plugin",
  "mattbangert/kubectl-zsh-plugin",
  "mattberther/zsh-pyenv",
  "mattcl/virtualenv-mod",
  "matthieusb/act",
  "matthieusb/zsh-edward",
  "matthieusb/zsh-sdkman",
  "MattiaG-afk/gentoo-ohmyzsh",
  "mattmc3/pz",
  "mattmc3/zsh-safe-rm",
  "matt-sungwook/ohmyzsh-mattizer-theme",
  ...
  "mfaerevaag/wd",
  "mgryszko/jvm",
  "mh-firouzjaah/mh-fzj-oh-my-zsh-theme-v1",
  ...
  "n1trux/awesome-sysadmin",
  "naens/zwsh",
  "narrensingh/zsh-custom-theme-narren",
  "natterstefan/toggl-zsh-plugin",
  ...
  "netresearch/jumpstorm-zsh-plugin",
  "nichus/qi3ber2",
  "nichus/zsh-tmux-multisession",
  "NicolaiRuckel/nidoranarion",
  ...
  "ninrod/gradle-zsh-completion",
  "ninrod/pass-zsh-completion",
  "Niverton/zsh-bumblebee-plugin",
  "nivv/operator-theme",
  ...
  "notf0und/zsh-vapor",
  "notnek/zsh-theme",
  "NotTheDr01ds/zsh-plugin-monthrename",
  "nralbrecht/gimmezsh",
  ...
  "Patr1ot/clean.zsh-theme",
  "patrick330602/linuxer",
  "patrick330602/termuxer",
  "PatTheMav/minimal2",
  "PatTheMav/zimfw-extras",
  "patwhatev/rzh",
  ...
  "perlpunk/App-AppSpec-p5",
  "perlpunk/MooseX-App-Plugin-ZshCompletion",
  "persiliao/persi-zsh-theme",
  "peterhurford/git-aliases.zsh",
  "peterhurford/git-it-on.zsh",
  "peterhurford/up.zsh",
  "petermbenjamin/purity",
  "pfahlr/zsh_plugin_loremipsum",
  ...
  "primait/docker-enter-completion",
  "probe2k/probe_zsh",
  "prototype27/kketcham",
  "pschmitt/emoji-fzf.zsh",
  "pseyfert/zsh-gitlab-runner-completion",
  ...
  "rgalite/zsh-plugin-ibtool",
  "rhklite/palenight_zsh_theme",
  "rhuang2014/brew",
  "richardmoyer/baseballfunfacts",
  "rileytwo/kiss",
  "rluders/laradock-workspace-zsh",
  "rmrs/firebase-zsh",
  "RobertAudi/tsm",
  "RobertKozak/fluent-git",
  "robertzk/hipchat.zsh",
  "robertzk/send.zsh",
  "robin-mbg/switch-git",
  ...
  "rocky/zshdb",
  "roman-geraskin/xxh-plugin-zsh-zshrc",
  "romch007/node-ace-zsh-completion",
  "romkatv/powerlevel10k",
  "romkatv/zsh4humans",
  "ronmackley/frank-theme",
  ...
  "sbfaulkner/chgo-plugin-zsh",
  "sbfaulkner/dev-plugin-zsh",
  "Sbodiu-pivotal/fly-zsh-autocomplete-plugin",
  "sbugzu/gruvbox-zsh",
  "schanur/aftermath",
  ...
  "Seinh/git-prune",
  "seletskiy/zsh-favorite-directories",
  ...
  "squarefrog/zsh-carthage",
  "srijanshetty/gulp-autocompletion-zsh",
  ...
  "TamCore/virtuozzo-zsh-plugin",
  "taPublic/zsh-theia-dev-tools",
  "tarjoilija/zgen",
  "Tarrasch/antigen-hs",
  ...
  "TheGrowingPlant/symfony.plugin.zsh",
  "therzka/zemoji",
  ...
  "timothyrowan/betterbrew-zsh-plugin",
  "tinyRatP/ys",
  ...
  "tomsquest/q.plugin.zsh",
  "tong/zsh.plugin.hashlink",
  "tong/zsh.plugin.haxelib",
  "tonyseek/oh-my-zsh-seeker-theme",
  "tonyseek/oh-my-zsh-virtualenv-prompt",
  "TooSchoolForCool/darksoku-zsh-theme",
  "torifat/nnvm",
  "torifat/npms",
  "ToruIwashita/sys-diver-zsh",
  "totoroot/plantyhoe.zsh-theme",
  "toytag/robbyrussell-fullpath.zsh-theme",
  "trapd00r/zsh-syntax-highlighting-filetypes",
  "trystan2k/zsh-npm-plugin",
  "trystan2k/zsh-tab-title",
  "ttttmr/sy-zsh-theme",
  "tweekmonster/nanofish",
  "tybritten/pks-zsh-autocomplete-plugin",
  ...
  "zaari/karu",
  "zackintosh/fixnumpad-osx.plugin.zsh",
  ...
  "zdharma/pm-perf-test",
  "zdharma/zconvey",
  "zdharma/zflai",
  "zdharma/zgdbm",
  "zdharma/zinit",
  "zdharma/zinit-configs",
  "zdharma/zredis",
  ...
  "ztomer/fantasque_awesome_powerline",
  "zulu-zsh/zulu",
  "zunit-zsh/zunit",
...
lists.set("awesome-docker", [
  "abesto/docker-compose-graphviz",
  "adlogix/docker-machine-nfs",
  "adrianmo/powerline-docker",
  "aelsabbahy/goss",
  "aind-containers/aind",
  "alexaandrov/stitchocker",
  "alexei-led/pumba",
  ...
  "AonCyberLabs/Docker-Secure-Deployment-Guidelines",
  "apache/mesos",
  "apache/openwhisk",
  "apocas/dockerode",
  ...
  "avirshup/DockerMake",
  "awesome-selfhosted/awesome-selfhosted",
  "awesome-startup/docker-compose",
  ...
  "bsideup/forward2docker",
  "bubenkoff/vagrant-docker-example",
  ...
  "crosbymichael/dockersql",
  "CtripCloud/docker-make",
  "cuigh/swirl",
  "Dataman-Cloud/crane",
  "decryptus/monit-docker",
  ...
  "moonbuggy/docker-dnsmasq-updater",
  "moshebe/gebug",
  "mudler/docker-companion",
  "mutable/container-factory",
  "n1trux/awesome-sysadmin",
  "nandoquintana/docker-missing-tools",
  "nanobox-io/nanobox",
  "ncopa/su-exec",
  "netdata/netdata",
  "netvarun/docket",
  ...
  "stelligent/mu",
  "Storidge/quick-start",
  "Stratoscale/skipper",
  "subuser-security/subuser",
  "sudo-bmitch/docker-config-update",
  "SUSE/Portus",
  "swarmpit/swarmpit",
  "swipely/dockly",
  "systemslab/popper",
...
lists.set("awesome-vscode", [
  ...
  "essence-language/vscode-extension",
  ...
  "pushqrdx/monokai.",
  "samverschueren/vscode-set-text",
  "sindresorhus/awesome.",
  "sozercan/OpenInCode",
  "vikrantnegi/vscode-personal-preference-setting",
  "xojs/xo.",
]);

lists.set("awesome-python", [
  "0rpc/zerorpc-python",
  "aaugustin/websockets",
  "abhiTronix/vidgear",
  "aboSamoor/polyglot",
  "Acrotrend/awesome-dash",
  "ageitgey/face_recognition",
  "agiliq/merchant",
  "ahupp/python-magic",
  ...
  "soravux/scoop",
  "sorrycc/awesome-javascript#data-visualization.*",
  "sphinx-doc/sphinx",
  "spotify/annoy",
  ...
  "vandersonmota/model_mommy",
  "vinta/awesome-python",
  "vinta/awesome-python#restful-api.*",
  "vinta/pangu.py",
  "vispy/vispy",
...
lists.set("awesome-android-ui", [
  ...
  "yqritc/RecyclerView-MultipleViewTypesAdapter",
  "zach-klippenstein/compose-backstack",
  "zhanyongsheng/BrokenView",
...
lists.set("awesome-d3", [
  ...
  "dk8996/Gantt-Chart",
  "earthjs/earthjs",
  "ebemunk/chess-dataviz",
  "efekarakus/d3-peaks",
  "eisman/neo4jd3",
  "emeeks/d3-carto-map",
  "emeeks/d3.svg.circularbrush",
  "emeeks/d3.svg.ribbon",
  "emeeks/semiotic",
  "epochjs/epoch",
  "erikbrinkman/d3-dag",
  "ErikGartner/dTree",
  "ErikOnBike/d3-template",
  "esbullington/react-d3",
  "eventbrite/britecharts",
  "fabriciotav/d3-snippets-for-sublime-text-2",
  "Fil/d3-geo-voronoi",
  "Fil/d3-inertia",
  "finnfiddle/potion",
  ...
  "gka/d3-jetpack",
  "glena/d3-resume",
  "GlobalWebIndex/d3scription",
  "GopherJ/Vs",
  "HarryStevens/d3-geo-scale-bar",
  "heavysixer/d4",
  "hshoff/vx",
  "ignacioola/insights",
  "ignoreintuition/v-chart-plugin",
  "imaginea/uvCharts",
  "imkevinxu/xkcdgraphs",
  ...
  "kmandov/d3-horizon-chart",
  "knsv/mermaid",
  "kotojs/kotojs",
  "koudelka/d3-message-sequence",
  "krispo/angular-nvd3",
  ...
  "schnerd/d3-scale-cluster",
  "sebastian-meier/d3.geo2rect",
  "sebastian-meier/d3.sketchy",
  "shawnbot/topogram",
  "shutterstock/rickshaw",
  "sindresorhus/awesome",
  "skokenes/d3-lasso",
  ...
  "tracyhenry/Kyrix",
  "twitter/d3kit",
  "twosixlabs/d3-force-reuse",
  "uber/react-vis",
  "vega/vega",
  "vega/vega-lite",
  "vega/vega-lite-api",
  "vijithassar/d3-history",
  "vijithassar/d3-xray",
  "vizabi/vizabi",
  "wbkd/d3-extended",
